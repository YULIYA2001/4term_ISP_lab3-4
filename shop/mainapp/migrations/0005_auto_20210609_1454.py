...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0004_auto_20210609_0936'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ в обработке'), ('ready', 'Заказ готов'), ('completed', 'Заказ завершен')], default='new', max_length=100, verbose_name='Статус заказа')),
